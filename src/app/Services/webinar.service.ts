...
export class WebinarService {
  ...
  RegisterInWebinar(path: string, body: any): Observable<object> {
    return this.http.post(environment.apiUrl + path, body).pipe(tap(res => res), catchError(e => {
      throw new Error(e);
    }))
  }

  CreateWebinar(path: string, formData: FormData, formValue: any): Observable<object> {
  ...
  UpdateWebinar(path: string, formData: FormData, formValue: any): Observable<object> {
  ...
  deleteWebinar(path: string): Observable<object> {
    return this.http.delete(environment.apiUrl + path).pipe(tap(res => res), catchError(e => {
      throw new Error(e);
    }))
  }
